...
{
	if (region.a6.av === region.bj.av)
	{
		return 'on line ' + region.a6.av;
	}
	return 'on lines ' + region.a6.av + ' through ' + region.bj.av;
}
...
var author$project$Bench$foldl = F3(
...
var author$project$Bench$reverse = function $reverse (list) {
    return author$project$Bench$foldl.f(elm$core$List$cons, _List_Nil, list);
};
var elm$core$Basics$add = _Basics_add;
var elm$core$Basics$gt = _Utils_gt;
var author$project$Bench$foldrHelper = F4(
	function $foldrHelper (fn, acc, ctr, ls) {
		if (!ls.b) {
			return acc;
		} else {
			var a = ls.a;
			...
			if (!r1.b) {
				...
				var r2 = r1.b;
				if (!r2.b) {
				    return fn.f(a, fn.f(b, acc));
				} else {
					var c = r2.a;
					var r3 = r2.b;
					if (!r3.b) {
					    return fn.f(a, fn.f(b, fn.f(c, acc)));
					} else {
						var d = r3.a;
						var r4 = r3.b;
					    var res = (ctr > 500) ? author$project$Bench$foldl.f(fn, acc, author$project$Bench$reverse(r4)) : author$project$Bench$foldrHelper.f(fn, acc, ctr + 1, r4);
					    return fn.f(a, fn.f(b, fn.f(c, fn.f(d, res))));
					}
				}
			}
		}
	});
var author$project$Bench$foldr = F3(
	function $foldr (fn, acc, ls) {
	    return author$project$Bench$foldrHelper.f(fn, acc, 0, ls);
	});
var author$project$Bench$filter = F2(
	function $filter (isGood, list) {
	    return author$project$Bench$foldr.f(
			F2(
				function (x, xs) {
				    return isGood(x) ? elm$core$List$cons.f(x, xs) : xs;
				}),
			_List_Nil,
			list);
	});
var author$project$Bench$map = F2(
	function $map (f, xs) {
	    return author$project$Bench$foldr.f(
			F2(
				function (x, acc) {
				    return elm$core$List$cons.f(f(x), acc);
				}),
			_List_Nil,
			xs);
	});
...
var author$project$Bench$suite = function () {
	var intList = A2(elm$core$List$range, 1, 1000);
	var stringList = A2(elm$core$List$map, elm$core$String$fromInt, intList);
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						'ints',
						function (_n0) {
							return author$project$Bench$reverse(intList);
						}),
						A2(
						elm_explorations$benchmark$Benchmark$benchmark,
						'strings',
						function (_n1) {
							return author$project$Bench$reverse(stringList);
						})
					])),
				A2(
				elm_explorations$benchmark$Benchmark$describe,
				...
				_List_fromArray(
					[
						...
						'int +',
						function (_n2) {
						    return author$project$Bench$foldl.f(elm$core$Basics$add, 0, intList);
						}),
						A2(
						elm_explorations$benchmark$Benchmark$benchmark,
						'string ++',
						function (_n3) {
						    return author$project$Bench$foldl.f(elm$core$Basics$append, '', stringList);
						})
					])),
				A2(
				elm_explorations$benchmark$Benchmark$describe,
				...
				_List_fromArray(
					[
						...
						'* 2',
						function (_n4) {
						    return author$project$Bench$map.f(
								function (a) {
									return a * 2;
								},
								intList);
						...
						'String reverse',
						function (_n5) {
						    return author$project$Bench$map.f(elm$core$String$reverse, stringList);
						})
					])),
				A2(
				elm_explorations$benchmark$Benchmark$describe,
...
var author$project$Console$Step = elm$core$Basics$identity;
var elm$core$Process$sleep = _Process_sleep;
var elm$core$Task$andThen = _Scheduler_andThen;
var author$project$Console$breakForRender = function (task) {
	return A2(
...
var author$project$Console$progress = _Platform_outgoingPort('progress', elm$json$Json$Encode$string);
...
var author$project$Console$next = function (benchmark) {
	return elm_explorations$benchmark$Benchmark$done(benchmark) ? author$project$Console$progress('Done') : A2(
		elm$core$Task$perform,
		elm$core$Basics$identity,
		author$project$Console$breakForRender(
	...
	function (msg, _n0) {
		...
		return _Utils_Tuple2(
			...
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						author$project$Console$progress('Stepping'),
						author$project$Console$next(benchmark)
					])));
	});
...
var author$project$Console$main = elm$core$Platform$worker(
	{
		cm: elm$core$Basics$always(
			_Utils_Tuple2(
				author$project$Bench$suite,
				elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							author$project$Console$progress('Starting...'),
							author$project$Console$next(author$project$Bench$suite)
						])))),
		cK: elm$core$Basics$always(elm$core$Platform$Sub$none),
		cO: author$project$Console$update
	});
_Platform_export({'Console':{'init':author$project$Console$main(
