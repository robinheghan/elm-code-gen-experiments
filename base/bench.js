...
var elm$core$List$foldl = F3(
	function $List$foldl (func, acc, list) {
		foldl:
		while (true) {
			if (!list.b) {
				return acc;
...
var elm$core$List$reverse = function $List$reverse (list) {
	return A3(elm$core$List$foldl, elm$core$List$cons, _List_Nil, list);
};
var elm$core$List$foldrHelper = F4(
	function $List$foldrHelper (fn, acc, ctr, ls) {
		if (!ls.b) {
			return acc;
		} else {
			var a = ls.a;
...
var elm$core$List$foldr = F3(
	function $List$foldr (fn, acc, ls) {
		return A4(elm$core$List$foldrHelper, fn, acc, 0, ls);
	});
var elm$core$List$filter = F2(
	function $List$filter (isGood, list) {
		return A3(
			elm$core$List$foldr,
			F2(
				function (x, xs) {
			...
			[
				...
				_List_fromArray(
					[
						...
						'ints',
						function (_n0) {
							return elm$core$List$reverse(intList);
						}),
						A2(
						elm_explorations$benchmark$Benchmark$benchmark,
						'strings',
						function (_n1) {
							return elm$core$List$reverse(stringList);
						})
					])),
				A2(
				elm_explorations$benchmark$Benchmark$describe,
				...
				_List_fromArray(
					[
						...
						'int +',
						function (_n2) {
							return A3(elm$core$List$foldl, elm$core$Basics$add, 0, intList);
						}),
						A2(
						elm_explorations$benchmark$Benchmark$benchmark,
						'string ++',
						function (_n3) {
							return A3(elm$core$List$foldl, elm$core$Basics$append, '', stringList);
						})
					])),
				A2(
				elm_explorations$benchmark$Benchmark$describe,
				...
				_List_fromArray(
					[
						...
						'String reverse',
						function (_n5) {
							return A2(elm$core$List$map, elm$core$String$reverse, stringList);
						})
					])),
				A2(
				elm_explorations$benchmark$Benchmark$describe,
